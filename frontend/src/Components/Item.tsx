...
export default function Item({ food }: itemProps) {
  ...
  console.log(steps);
  return (
    <div className="w-[98%] border-6 border-green-500 mt-4 p-2 place-self-center flex flex-row">
      <div className="mr-4">
        <h1 className="text-4xl font-bold place-self-center mb-4">
          {food.title}
        </h1>
        <img className="rounded-2xl" src={food.image}></img>
        <div className="mt-4 mb-4">
          <h1 className="font-bold text-2xl place-self-center">
            INFORMATION:{" "}
          </h1>
          <ul className="place-self-center text-center">
